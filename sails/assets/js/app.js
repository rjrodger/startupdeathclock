$(function () {
  ...
  function setclock(params,updateform) { 
    ...
    var revm = params.revm ? parseInt(params.revm,10) : ''==params.revm ? 0 : 0;
    var expm = params.expm ? parseInt(params.expm,10) : ''==params.expm ? 0 : 50000;
    var cash = params.cash ? parseInt(params.cash,10) : ''==params.cash ? 0 : 500000;
    ...
    var death = new Date();
    var start = 8 == from.length ? new Date(parseInt(from.substring(0,4),10),parseInt(from.substring(4,6),10)-1,parseInt(from.substring(6,8),10)) : death;
